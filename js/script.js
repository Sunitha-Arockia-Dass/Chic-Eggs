//Input words
const threeWords = ["box", "buy", "dog", "van", "bye", "pat", "bug", "eat","dry","ego","air","aim","car","cap","mad","rat","law","pet","win","zip"];
const fourWords = ["card", "road", "push", "load", "love", "ship", "kind","acid","ugly","lose","barn","cash","game","mate","name","nail","quit","star","vain","yolk"];
const fiveWords = ["faith", "lunch", "towel", "sharp", "stone", "earth","brick","abuse","waste","yacht","voice","light","brave","focus","fight","crazy","clown","brake","bring","legal"];
const sixWords = [
  "spread",
  "silent",
  "object",
